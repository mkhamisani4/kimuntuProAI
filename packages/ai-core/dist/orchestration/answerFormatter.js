 ...
 */
export function buildExecutorDeveloperPrompt(plan) {
 ...
 */
export function buildExecutorUserMessage(request, plan, context) {
    const parts = [];
    // Request JSON
    parts.push('=== REQUEST ===');
 ...
 */
export function buildExecutorMessages(request, plan, context) {
    return [
        {
            role: 'system',
 ...
 */
export function parseSections(rawOutput) {
    const sections = {};
    // Split by ## headings
 ...
 */
export function buildRAGSources(chunks) {
 ...
 * @returns AssistantSource array
 */
export function buildWebSources(results) {
 ...
 */
export function mapCitationsToSources(rawOutput, ragSources, webSources) {
 ...
 */
export function parseExecutorResponse(rawOutput, context) {
    // Parse sections
 ...
 */
export function validateSections(sections, requiredSections) {
    const sectionNames = Object.keys(sections);
    const missing = [];
    for (const required of requiredSections) {
        // Case-insensitive match
        const found = sectionNames.some((name) => name.toLowerCase() === required.toLowerCase());
        if (!found) {
...
//# sourceMappingURL=answerFormatter.js.map