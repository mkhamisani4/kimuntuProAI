 ...
 */
export function buildCitation(chunk, index) {
    const citation = {
        id: `[${index}]`,
 ...
 */
function formatChunkWithCitation(chunk, citationIndex) {
 ...
 */
export function packContext(chunks, maxTokens, reserveTokens = 100) {
    if (chunks.length === 0) {
        return {
            context: '',
            citations: [],
