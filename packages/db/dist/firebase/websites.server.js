...
import { createWebsite as createWebsiteClient, updateWebsite as updateWebsiteClient, getWebsite as getWebsiteClient, listWebsites as listWebsitesClient, deleteWebsite as deleteWebsiteClient } from './websites.js';
/**
 ...
 * @returns Document ID
 */
export async function createWebsiteAdmin(website) {
 ...
 */
export async function getWebsiteAdmin(websiteId) {
    // Development mode: use client SDK
    if (!isAdminAvailable()) {
 ...
 */
export async function updateWebsiteAdmin(websiteId, updates) {
    // Development mode: use client SDK
    if (!isAdminAvailable()) {
 ...
 */
export async function listWebsitesAdmin(tenantId, userId, limitCount = 20) {
    // Development mode: use client SDK
    if (!isAdminAvailable()) {
 ...
 * @param websiteId - Document ID
 */
export async function deleteWebsiteAdmin(websiteId) {
    // Development mode: use client SDK
    if (!isAdminAvailable()) {
...
//# sourceMappingURL=websites.server.js.map