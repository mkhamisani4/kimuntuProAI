 ...
 */
import { db, Timestamp, collection, addDoc, query, where, orderBy, limit, getDocs, doc, deleteDoc, } from './client.js';
/**
 ...
 */
export async function listKeywords(tenantId, userId, campaignId, limitCount = 100) {
    try {
        const constraints = [
        ...
        const q = query(collection(db, 'marketing_keywords'), ...constraints, orderBy('createdAt', 'desc'), limit(limitCount));
...
//# sourceMappingURL=marketingKeywords.js.map