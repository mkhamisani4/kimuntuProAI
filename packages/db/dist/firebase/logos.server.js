...
import { createLogo as createLogoClient, updateLogo as updateLogoClient, getLogo as getLogoClient, deleteLogo as deleteLogoClient, unsetPrimaryLogoForUser as unsetPrimaryLogoForUserClient, } from './logos.js';
/**
 ...
 * @returns Document ID
 */
export async function createLogoAdmin(logo) {
 ...
 */
export async function getLogoAdmin(logoId) {
    // Development mode: use client SDK
    if (!isAdminAvailable()) {
        console.log('[Firestore] Using client SDK (development mode)');
 ...
 */
export async function updateLogoAdmin(logoId, updates) {
    // Development mode: use client SDK
    if (!isAdminAvailable()) {
        console.log('[Firestore] Using client SDK (development mode)');
 ...
 * @param logoId - Document ID
 */
export async function deleteLogoAdmin(logoId) {
    // Development mode: use client SDK
    if (!isAdminAvailable()) {
        console.log('[Firestore] Using client SDK (development mode)');
...
//# sourceMappingURL=logos.server.js.map