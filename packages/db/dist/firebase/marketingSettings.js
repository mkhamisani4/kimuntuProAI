 ...
 */
import { db, Timestamp, collection, query, where, getDocs, doc, setDoc, } from './client.js';
/**
 ...
 */
export async function getMarketingSettings(tenantId, userId) {
    try {
        const q = query(collection(db, 'marketing_settings'), where('tenantId', '==', tenantId), where('userId', '==', userId));
 ...
 */
export async function updateMarketingSettings(tenantId, userId, updates) {
    try {
...
//# sourceMappingURL=marketingSettings.js.map