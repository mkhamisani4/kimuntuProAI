...
import type { MarketingPost } from './marketing';
...
export async function createPost(
  post: Omit<MarketingPost, 'id' | 'createdAt' | 'updatedAt'>
): Promise<string> {
  try {
 ...
 */
export async function getPost(postId: string): Promise<MarketingPost | null> {
  try {
