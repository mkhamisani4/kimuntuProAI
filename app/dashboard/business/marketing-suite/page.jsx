    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-400">
          SEO, Email, and Social Media marketing automation
        </p>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur border border-gray-800 rounded-2xl p-8">
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Our comprehensive Marketing Suite is currently in development.
            This feature will automate your SEO, email campaigns, and social media presence
            to help you reach more customers and grow your business.
          </p>
          <Link
            href="/dashboard/business"
