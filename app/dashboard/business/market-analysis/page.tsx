...
import { Search, Clock, Lock, AlertTriangle, X, ArrowLeft } from 'lucide-react';
...
export default function MarketAnalysisPage() {
  ...
  return (
    <AssistantLayout
      title={t.biz_marketAnalysisTitle}
      description={t.biz_marketAnalysisSubtitle}
            ...
            <div className="bg-white/5 backdrop-blur border border-gray-800 rounded-2xl p-12 text-center">
              <div className="text-gray-400 text-lg">
                <p className="mb-2 flex items-center gap-2">
                  ...
                  {t.biz_describeMarket}
                </p>
                <p className="text-sm">{t.biz_marketAnalysisWillAppear}</p>
              </div>
            </div>
          )}
        </div>
