...
export function generatePDF(
  ...
  try {
    ...
    doc.text('Kimuntu AI Assistant', margin, yPosition);
    yPosition += 10;
    ...
    for (let i = 1; i <= totalPages; i++) {
      ...
      const footerText = `Page ${i} of ${totalPages} | Generated by Kimuntu AI`;
    ...
    const filename = `Kimuntu_AI_${metadata.assistantType}_${dateStr}.pdf`;
