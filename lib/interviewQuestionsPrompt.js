...
**LENGTH & BREVITY (do not skip):**
- Each question must stay **concise but still rich**: aim for **2–3 sentences only**, or roughly **60–110 words** per question—not a short one-liner, and not a long paragraph or mini-essay.
- **One main ask per question.** You may add **one** short clarifying clause (e.g. scale, constraint, or metric) if it helps; avoid stacking many sub-parts (a/b/c) or multiple unrelated prompts in one line.
- When shortening, **keep specificity**: still reference concrete tools, products, domains, or constraints from the job where relevant—brevity is not an excuse for generic filler.
