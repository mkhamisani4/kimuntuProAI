...
/**
 * Generate interview questions via POST /api/interview/generate-questions.
 * Prompt and OpenAI call run server-side; request/response are logged in the terminal.
 */
