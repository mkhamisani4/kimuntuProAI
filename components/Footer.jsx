...
const Footer = () => {
    ...
    const footerLinks = {
        product: [
            { name: 'Career Track', href: '/dashboard/career' },
            { name: 'Business Track', href: '/dashboard/business' },
            { name: 'Legal Track', href: '/dashboard/legal' },
            { name: 'Innovative Track', href: '/dashboard/innovative' },
