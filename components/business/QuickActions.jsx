  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8" role="region" aria-label="Quick actions">
      <ActionCard
        ...
        description="Basic plan (Medium/Pro coming soon)"
      ...
      <ActionCard
        ...
        description="AI-powered market intelligence and competitor insights"
        buttonText="Analyze Market"
        href="/dashboard/business/competitor-analysis"
        comingSoon
      />
      <ActionCard
        icon="🎯"
