                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {resources.map((resource, index) => (
                            ...
                            >
                                <div className={`w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center ${isDark ? 'bg-emerald-500/20' : 'bg-emerald-100'
                                    }`}>
                                    <resource.icon className={`w-8 h-8 ${isDark ? 'text-emerald-400' : 'text-emerald-600'
                                        }`} />
                                </div>
                        ...
                        {coverage.map((article, index) => (
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className={`${isDark ? 'text-emerald-400' : 'text-emerald-600'} hover:underline`}>
                                        Read →
                                    </button>
                                </div>
                            </div>
