...
/* ------------------------------------------------------------------ */
/*  [Legacy demo builder — no longer used]                             */
/* ------------------------------------------------------------------ */
...
const Chat = () => {
    ...
    const handleSend = useCallback(async () => {
        ...
        try {
            // Build message history for context (exclude timestamp, only role+content)
            const history = [...messages, userMessage].map(({ role, content }) => ({ role, content }));
            const responseText = await fetchAIResponse(history);
